      ...
      <div className="py-12 bg-orange-50" data-aos="fade-in">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-6">
            {categories.map((category, index) => (
              <button className="bg-white text-orange-500 px-6 py-3 rounded-lg font-semibold text-lg shadow-lg hover:bg-orange-600 hover:text-white transition" data-aos="fade-in" data-aos-delay={index * 100} key={index}>{category}</button>
